...
<section class="top-home myhome whiteClr" style="background-image: url(assets/images/whiteboard-animation.png);background-position: 50% 50%;
    ...
    <div class="col-lg-6 height-dog">
        ...
        <span><i>Whiteboard animated videos are the go-to standard for illustrating lectures and talks.</i></span>

        </h1>
        <p class="for-anim-2"><span>A whiteboard animation video is great for you if you don’t have any use for beautiful imagery, the most direct path to get your idea across.</span></p>
  ...
  <div class="container">
        ...
        <div class="app-container"> 
            ...
            <div class="tab-custom">
              ...
              <ul class="tabbing-links">
                  <li class="current" data-targetit="tabs-3danimation">White Board</li>
                ...
                <div class="tabs tabs-3danimation current row m-app-slider no-gutters for-works-load loadmore3d">
                    ...
                    $portfolio3d = "includes/portfolio-whiteboard.php"; 
                    include($portfolio3d); 
                    ?>
                </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="tab-custom">
                <ul class="tabbing-links">
                  <li class="current" data-targetit="tabs-vdpackages">White Board</li>
                </ul>
