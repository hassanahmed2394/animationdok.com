                                ...
                                <div class="app-input-group">
                                    ...
                                    <!-- <label class="selectlabel">Select Package</label> -->
                                            <select name="oPackage" id="packages"  disabled required>
                                                ...
                                                <option value="Premium Video Package - $999.00">Premium Video Package - $999.00</option>
                                                ...
                                                <option value="Special Video Package - $149.00" pack="47">Special Video Package - $149.00</option>
