<div class="col-sm-4">
  <div class="packagebox">
    ...
    <div class="">
      <div class="packhdbox">
        <h3 >Basic 3D</h3>
        <p class=""><span class="strike">$5990.00</span></p>
      </div>
      <div class="pack-wrap">
        ...
        <button class="packbtn" onClick="location.href='order?pack=24'">Order Now</button>
...
<div class="col-sm-4">
  <div class="packagebox">
    ...
    <div class="">
      <div class="packhdbox">
        <h3 >Standard 3D</h3>
        <p class=""><span class="strike">$9990.00</span></p>
      </div>
      <div class="pack-wrap">
        <div class="packpricing">
          <h2>$4,995.00  </h2>
...
<!--and brand revamps for companies.</p>-->
        ...
        <button class="packbtn" onClick="location.href='order?pack=25'">Order Now</button>
        <div class="list-scroll">
          <ul class="details">
...
<div class="col-sm-4">
  <div class="packagebox">
    ...
    <div class="">
      <div class="packhdbox">
        <h3 >Premium 3D</h3>
        <p class=""><span class="strike">$6995.00</span></p>
      </div>
      <div class="pack-wrap">
        <div class="packpricing">
          <h2>$6,995.00  </h2>
...
<!--and brand revamps for companies.</p>-->
        ...
        <button class="packbtn" onClick="location.href='order?pack=26'">Order Now</button>
        <div class="list-scroll">
          <ul class="details">
