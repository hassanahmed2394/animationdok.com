...
<div class="prvcy">
  <div class="container">
    <div class="row">
      ...
      <p>At Animation Dok, the privacy of our clients is our top priority on order@animationdok.com and we respect it as our own. Though we collect information from our clients, it is only used to make improvements in our customer services. Our company acknowledges that the maintenance and use of our clients' information is our responsibility. We DO NOT rent or sell the information that our clients provide us online.</p>
      ...
      <p>If you no longer wish to receive our newsletter and promotional communications, you may opt-out of receiving them by following the instructions included in each newsletter or communication or by emailing us at Or calling us at +1 973 265 7199</p>
      ...
      <p>If you have any questions about security on our Web site, you can send email us at <a href="mailto:order@animationdok.com">order@animationdok.com</a></p>
      ...
      <p>We reserve the right to disclose your personally identifiable information as required by law and when we believe that disclosure is necessary to protect our rights and/or comply with a judicial proceeding, court order, or legal process served on our Web site.
      </p>

      <h4>Questions</h4>
      <p>If you have any questions regarding our Privacy Policy or our use of your information, call our toll free number (+1 973 265 7199) or email us on <a href="mailto:order@animationdok.com">order@animationdok.com</a></p>
...
<!--                                    class="phone" href="tel:+19732657199">+1 862 772 1016</a>-->
<!--                                </div>-->
<!--                                <div class="follow-wrap">-->
<!--                                    <h3 class="title">Follow</h3>-->
<!--                                    <ul>-->
<!--                                     <li><a href="https://www.facebook.com/animationdok/" target="_blank"><i class="fa fa-facebook"></i></a></li>-->
<!--                                     <li><a href="https://www.linkedin.com/company/design-dok"><i class="fa fa-linkedin"></i></a></li>-->
<!--                                     <li><a href="https://dribbble.com/animationdok" target="_blank"><i class="fa fa-dribbble"></i></a></li>-->
<!--                                     <li><a href="https://www.instagram.com/animationdok/" target="_blank"><i class="fa fa-instagram"></i></a></li>-->
<!--                                   </ul>-->
<!--                                </div>-->
<!--                                <div class="map">-->
...
<!--                            </div>-->
<!--                            <ul>-->
<!--                                    <li><a href="<?php echo $path;?>terms">Terms & Condition</a></li>-->
