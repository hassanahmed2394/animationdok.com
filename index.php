...
<title>Home</title>
<meta name="description"  content="Get the perfect Video Animation - or any animation in over 90 categories specializing in animation" />
...
<section class="top-home myhome whiteClr">
<video class="mainvideo" autoplay loop muted playsinline preload="metadata">
      <source src="assets/images/homevideo.mp4" type="video/mp4">
     <source src="assets/images/homevideo.ogg" type="video/ogg">
...
<div class="video-overlay"></div>
    ...
    <div class="col-lg-6 height-dog">
        ...
        <span><i>Everyone’s got a story to tell, so why not to make it interesting with  Explainer video?</i></span>

        </h1>
        <p class="for-anim-2"><span>If you’re after great video content for your service, product or for a social media content simply lodge your interest below.</span></p>
...
<section class="newSectionhome">
  <p>We rated <strong>8.9</strong> out of <strong>10</strong> <span><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i></span> served <strong>300+</strong> satisfied customers. </p>
  <div class="mybannerform shadnone">
                <img data-src="assets/images/goodfirms.png" alt="" class="lazy">
                <img data-src="assets/images/clutch.png" alt="" class="lazy">
                <img data-src="assets/images/top-design-firm.png" alt="" class="lazy">
                <img data-src="assets/images/top-digital-agency.png" alt="" class="lazy">
     </div>
</section>
...
<section class="section-padding testimonials testimonials-custom-add wow fadeInDown" data-wow-delay="0.2s">
  ...
  <div class="row">
        <div class="col-md-12">
                ...
                <h2 class="wow fadeInDown" data-wow-delay="0.2s">Make Great Videos That Perform</h2>
                <p>We’re a custom animated video production company that focuses on 
engaging video content for maximum customer retention.</p>
     ...
     <div>
        ...
        <div class="row set-height nopaddres">
          <div class="col-md-6 col-xs-12">

          <div class="testi_box_video">


          <div class="user_aplha-video">
          <!-- <video autoplay loop class="">
              <source src="https://www.animationshub.com/videos/character-animation.mp4" type="video/mp4" />
            </video> -->
            <img data-src="assets/images/2d-character.png" class="lazy">
        </div>
       
            <div class="VideoTextSer">
            <h3>2D Character Animation</h3>
            <p>Nothing portrays a video script better than an animated character. Our custom 2D character animation experts love to provide you with an interactive video solution.</p>

          <!-- <span class="testi_owner">Cynthia Rashford, Masterpiece Premium </span> -->
          </div>
          ...
          <div class="user_aplha-video">
            <!-- <video autoplay loop class="">
              <source src="data:image/gif;base64,R0lGODlhAQABAAAAACwAAAAAAQABAAA=" data-src="https://www.animationshub.com/videos/graphics-animation.mp4" type="video/mp4" />
            </video> --> 
            <img data-src="assets/images/2d-graphics2.png" class="lazy">
        </div>
          <div class="VideoTextSer">
            <h3>2D Graphics Animation</h3>
             <p>Animated Graphic results in an estimated increase of 56% ROI for businesses worldwide.From multinationals to startups, 2D graphics animation is fit for all growth oriented businesses. </p>
        ...
        <div class="user_aplha-video">
          <!-- <video autoplay loop class="">
              <source src="data:image/gif;base64,R0lGODlhAQABAAAAACwAAAAAAQABAAA=" data-src="https://www.animationshub.com/videos/explainer-animation.mp4" type="video/mp4" />
            </video> -->
            <img data-src="assets/images/explainer-video3.png" class="lazy">
        </div>
            <div class="VideoTextSer">
            <h3>Explainer Video Animation</h3>
             <p>Nothing explains your business goals to your customer better than an animated explainer video.Talk to our professionals regarding your explainer video needs today.</p>
         ...
         <div class="user_aplha-video">
          <!-- <video autoplay loop class="">
              <source src="data:image/gif;base64,R0lGODlhAQABAAAAACwAAAAAAQABAAA=" data-src="https://www.animationshub.com/videos/whiteboard-animation.mp4" type="video/mp4" />
            </video> -->
            <img data-src="assets/images/whiteboard4.png" class="lazy">
        </div>
          <div class="VideoTextSer">
            <h3>Whiteboard Animation</h3>
             <p>Be as explanatory and vivid as can be with custom produced whiteboard animated videos. Our experts are known worldwide for interactive and engagement whiteboard animation services.</p>
        ...
        <div class="row set-height nopaddres">
         ...
         <div class="user_aplha-video">
          <!-- <video autoplay loop class="">
              <source src="data:image/gif;base64,R0lGODlhAQABAAAAACwAAAAAAQABAAA=" data-src="https://www.animationshub.com/videos/3d-animation.mp4" type="video/mp4" />
            </video> -->
            <img data-src="assets/images/3d-animation5.png" class="lazy">
        </div>
            <div class="VideoTextSer">
            <h3>Interactive 3D Animation</h3>
             <p>Make your animated videos as lively and beautiful as can be with interactive 3D animation services for your business. Get a custom script for each of your interactive 3D animated videos.</p>
          ...
          <div class="user_aplha-video">
            <!-- <video autoplay loop class="">
              <source src="data:image/gif;base64,R0lGODlhAQABAAAAACwAAAAAAQABAAA=" data-src="https://www.animationshub.com/videos/typography-animation.mp4" type="video/mp4" />
            </video> -->
            <img data-src="assets/images/Typography.png" class="lazy">
        </div>
            <div class="VideoTextSer">
            <h3>Typography Animation</h3>
             <p>Make words look beautiful as never seen before with our one-of-a-kind custom typography animation services. Discuss your ideas and script with us today.</p>
...
<div class="text-center portfolio_button bottom"><p>Let’s conceptualize your 
idea and animate it</p> 
<a href="<?php echo $path;?>contact" class="pur-bg">Let’s Get Started</a></div>
     ...
     <div class="col-md-12">
      <ul>
        ...
        <li>
          <ul class="subimages">
            <li>
              <img src="data:image/gif;base64,R0lGODlhAQABAAAAACwAAAAAAQABAAA=" data-src="assets/images/motionicon1.png">
              <h6>Character<br> Animation</h6>
            </li>
            <li>
              <img src="data:image/gif;base64,R0lGODlhAQABAAAAACwAAAAAAQABAAA=" data-src="assets/images/motionicon2.png">
              <h6>2D Graphics <br> Animation</h6>
            </li>
            <li>
              <img src="data:image/gif;base64,R0lGODlhAQABAAAAACwAAAAAAQABAAA=" data-src="assets/images/motionicon3.png">
              <h6>Explainer Video <br> Animation</h6>
            </li>
            <li>
              <img src="data:image/gif;base64,R0lGODlhAQABAAAAACwAAAAAAQABAAA=" data-src="assets/images/motionicon4.png">
              <h6>Whiteboard <br> Animation</h6>
            </li>
            <li>
              <img src="data:image/gif;base64,R0lGODlhAQABAAAAACwAAAAAAQABAAA=" data-src="assets/images/motionicon5.png">
...
<!-- <section class="servicesSectionnew">
  <div class="container">
    <h2>Make Great Videos That Perform</h2>
    <ul>
       <li><img src="data:image/gif;base64,R0lGODlhAQABAAAAACwAAAAAAQABAAA=" data-src="assets/images/animationicon1.png"><span>Promotional <br>videos</span></li>
       <li><img src="data:image/gif;base64,R0lGODlhAQABAAAAACwAAAAAAQABAAA=" data-src="assets/images/animationicon1.png"><span>2D/3D  <br>video</span></li>
       <li><img src="data:image/gif;base64,R0lGODlhAQABAAAAACwAAAAAAQABAAA=" data-src="assets/images/animationicon1.png"><span>whiteboard  <br>video</span></li>
       <li><img src="data:image/gif;base64,R0lGODlhAQABAAAAACwAAAAAAQABAAA=" data-src="assets/images/animationicon1.png"><span>Product  <br>video</span></li>
       <li><img src="data:image/gif;base64,R0lGODlhAQABAAAAACwAAAAAAQABAAA=" data-src="assets/images/animationicon1.png"><span>Music animated  <br>video</span></li>
    </ul>
  </div>
</section> -->


<!-- <section class="servics_slide">

  <h2>Services</h2>
   <div class="fullimg">
     <figure style="background-image: url(assets/images/tabs-section.png);"></figure>
     <figure style="background-image: url(assets/images/tabs-section.png);"></figure>
     <figure style="background-image: url(assets/images/tabs-section.png);"></figure>
     <figure style="background-image: url(assets/images/tabs-section.png);"></figure>
     <figure style="background-image: url(assets/images/tabs-section.png);"></figure>
     ...
     <ul class="thmbsnav">
       <li><img src="data:image/gif;base64,R0lGODlhAQABAAAAACwAAAAAAQABAAA=" data-src="assets/images/animationicon1.png"><span>Hand sketch video</span></li>
       <li><img src="data:image/gif;base64,R0lGODlhAQABAAAAACwAAAAAAQABAAA=" data-src="assets/images/animationicon1.png"><span>Promotional videos</span></li>
       <li><img src="data:image/gif;base64,R0lGODlhAQABAAAAACwAAAAAAQABAAA=" data-src="assets/images/animationicon1.png"><span>2D/3D video</span></li>
       <li><img src="data:image/gif;base64,R0lGODlhAQABAAAAACwAAAAAAQABAAA=" data-src="assets/images/animationicon1.png"><span>whiteboard video</span></li>
       <li><img src="data:image/gif;base64,R0lGODlhAQABAAAAACwAAAAAAQABAAA=" data-src="assets/images/animationicon1.png"><span>Product video</span></li>
       <li><img src="data:image/gif;base64,R0lGODlhAQABAAAAACwAAAAAAQABAAA=" data-src="assets/images/animationicon1.png"><span>Music animated video</span></li>
    </ul>
</section> -->
        ...
        <div class="app-container"> 
            ...
            <div class="tab-custom">
              ...
              <ul class="tabbing-links">
                <li class="current" data-targetit="tabs-all">All</li>
                <li data-targetit="tabs-motiongraphics">2D Animation</li>
                <li class="" data-targetit="tabs-3danimation">3D Animation</li>
                ...
                <div class="tabs tabs-all current row m-app-slider no-gutters for-works-load loadmoreall">
                    <?php
                    $portfolioall = $_SERVER['HTTP_HOST']; 
                    $portfolioall = "includes/portfolio-all.php"; 
                    include($portfolioall); 
                    ?>
                </div>
                    ...
                    <div class="list">
                        <div id='#img-hover' class="row m-book-slider">
                            <div class="col-md-4">
                                <div class="item">
                                    <a href="#">
                                        <img class="book-size lazy" data-src="assets/images/process-script.svg">
                                    </a>
<!--                                    <div class="image book1 img-hover"></div>-->
                            ...
                            <div class="col-md-4">
                                <div class="item">
                                    <a href="#">
                                        <img class="book-size lazy" data-src="assets/images/process-storyboard.svg">
                                    </a>
<!--                                    <div class="image book2 img-hover"></div>-->
                            ...
                            <div class="col-md-4">
                                <div class="item">
                                    <a href="#">
                                        <img class="book-size lazy" data-src="assets/images/process-design.svg">
                                    </a>
<!--                                    <div class="image book3 img-hover"></div>-->
                            ...
                            <div class="col-md-4">
                                <div class="item">
                                    <a href="#">
                                        <img class="book-size lazy" data-src="assets/images/process-animation-01.svg">
                                    </a>
<!--                                    <div class="image book3 img-hover"></div>-->
...
<div class="col-md-4">
                                <div class="item">
                                    <a href="#">
                                        <img class="book-size lazy" data-src="assets/images/process-music-sound-01.svg">
                                    </a>
<!--                                    <div class="image book3 img-hover"></div>-->
                            ...
                            <div class="col-md-4">
                                <div class="item">
                                    <a href="#">
                                        <img class="book-size lazy" data-src="assets/images/process-render-01.svg">
                                    </a>
<!--                                    <div class="image book3 img-hover"></div>-->
        ...
        <div class="row margin-bottom-20 margin-top-20 quick-contact-slider">
            ...
            <div class="col has-border wow fadeInLeft" data-wow-delay="0.2s">
                ...
                <div class="quality">
                       ...
                       <div class="quality-img"><img data-src="assets/images/constant-client-coordination.svg" class="lazy"></div>
            ...
            <div class="col has-border wow fadeInLeft" data-wow-delay="0.2s">
                <div class="quality">
                       ...
                       <div class="quality-img"><img data-src="assets/images/supreme-customer-satisfaction.svg" class="lazy"></div>
            ...
            <div class="col has-border wow fadeInLeft" data-wow-delay="0.3s">
               <div class="quality">
                       ...
                       <div class="quality-img"><img data-src="assets/images/100percent-ownership-rights.svg" class="lazy"></div>
            ...
            <div class="col has-border wow fadeInLeft" data-wow-delay="0.4s">
               <div class="quality">
                       ...
                       <div class="quality-img"><img data-src="assets/images/secure-money-back-guarantee.svg" class="lazy"></div>
            ...
            <div class="col wow fadeInLeft" data-wow-delay="0.5s">
                <div class="quality">
                       ...
                       <div class="quality-img"><img data-src="assets/images/industry-proven-professionals.svg" class="lazy"></div>
