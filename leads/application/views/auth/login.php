...
<body>
	...
	<nav class="navbar navbar-default navbar-embossed navbar-fixed-top" role="navigation" style="background:#4f31fe;">
		<div class="navbar-header">
			<button type="button" class="navbar-toggle" data-toggle="collapse" data-target="#navbar-collapse-01">
				<span class="sr-only">Toggle navigation</span>
			</button>
			<a class="navbar-brand" href="<?php echo base_url();?>"><img alt="" src="<?php echo base_url();?>images/icons/box.svg" style="width: 100px;"></a>
		</div>
    			...
    			<form action="<?php echo site_url("auth/login");?>" method="post">
    				...
    				<div class="form-group">
    					<div class="input-group">
    						...
    						<input type="email" id="identity" name="identity" placeholder="Your email" class="form-control" tabindex="1">
    					</div>
    				</div>
    				...
    				<div class="form-group">
    					<div class="input-group">
    						...
    						<input type="password" id="password" name="password" placeholder="Your password" class="form-control" tabindex="2">
    					</div>
    				</div>

    				<label class="checkbox" for="remember">
    					<input type="checkbox" value="1" id="remember" data-toggle="checkbox" tabindex="3">
    					Remember Me
    				</label>

    				<button type="submit" style="background:#4f31fe;" class="btn btn-primary btn-embossed btn-block margin-top-20" tabindex="4">Log me in please</button>
