...
<section class="top-home myhome whiteClr" style="background-image: url(assets/images/2d-animation.png);background-position: 50% 50%;
    ...
    <div class="col-lg-6 height-dog">
        ...
        <span><i>Elevate your ideas into Animation.</i></span>

        </h1>
        <p class="for-anim-2"><span>Elevate your brand to the next level and turn your static design into an eye catching interactive.</span></p>
        ...
        <div class="app-container"> 
            ...
            <div class="tab-custom">
              ...
              <ul class="tabbing-links">
                  <li class="current" data-targetit="tabs-motiongraphics">2D Animation</li>
                  
                  
                </ul>

             
                <div class="tabs tabs-motiongraphics current row m-app-slider no-gutters for-works-load loadmorevideo">
                    <?php
