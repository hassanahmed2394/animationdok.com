  ...
  <div class="container">
        ...
        <div class="app-container"> 
            ...
            <div class="tab-custom">
              ...
              <ul class="tabbing-links">
                  <li class="current" data-targetit="tabs-screencast-animation">Screencast Animation</li>
                  
                  
                </ul>

             
                <div class="tabs tabs-screencast-animation current row m-app-slider no-gutters for-works-load loadmorescreenshot">
                    <?php
                    $portfolioscreenshotanimation = $_SERVER['HTTP_HOST']; 
                    $portfolioscreenshotanimation = "includes/portfolio-screenshot-animation.php"; 
                    include($portfolioscreenshotanimation); 
                    ?>
                </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="tab-custom">
                <ul class="tabbing-links">
                  <li class="current" data-targetit="tabs-vdpackages">Motion Graphics </li>
                </ul>
