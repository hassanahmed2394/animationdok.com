...
$(".phrase-inner").slick({
 ...
 // autoplaySpeed: 2000,
  ...
  $('.popular-slider').slick({
    ...
    size_threed = $(".loadmore3d .app-item").length;
    threed_size=6;
    $('.loadmore3d .app-item:lt('+threed_size+')').show();
    $('#load3dmore').click(function () {

        threed_size= (threed_size+4 <= size_threed) ? threed_size+4 : size_threed;
        if(threed_size==size_threed){
          $("#load3dmore").hide();
        }
        $('.loadmore3d .app-item:lt('+threed_size+')').slideDown();
    });
    
        size_threed = $(".loadmorewhiteboard .app-item").length;
    threed_size=6;
    ...
    size_threed = $(".loadmoreexplainer .app-item").length;
    threed_size=6;
