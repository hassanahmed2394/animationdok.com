    ...
    <div class="col-md-12">
      ...
      <div class="pricingboxes">
        ...
        <div class="leftarea">
          ...
          <a href="javascript:;" class="btn-packages">Get a Custom Quote</a>
        </div>
        <div class="rightarea">
          ...
          <ul class="ticklist">
            ...
            <li class="ralign">
              ...
              <a href="tel:19732657199"><h6>+1 973 265 7199</h6></a>
            </li>
            <!-- <li><span class="icon-check-circle"></span>Contact Insights</li>
            <li><span class="icon-check-circle"></span>Contact Insights</li> -->
          </ul>
        </div>
      </div>
