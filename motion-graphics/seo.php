...
<title>Take the fast lane to 1st page results.</title>
<meta name="description"  content="We bet you don't spend much time on the 2nd page of Google - so why should your website?" />
...
<section class="top-home myhome">
    ...
    <div class="col-lg-6 height-dog">
        ...
        <span><i>Take the fast lane to 1st page results.</i></span>
   
        </h1>
        <p class="for-anim-2"><span>We bet you don't spend much time on the 2nd page of Google - so why should your website?</span></p>
        <ul class="myticks for-anim-3">
          <li>1.6M Hours of Expertise</li>
          <li>200+ Digital Marketing Masters On Staff </li>
          <li>1,228 Websites Launched</li>
        </ul>

        <div class="bottom">
        <span class="watch-button" id="hire-us"></span>
        <a class="first-link" href="<?php echo $path;?>contact.php">Get you website 1st page results.</a>
    ...
    <div class="col-lg-6">
        <div class="fullwrap">
            <div class="mybanslider">
                ...
                <div class="item">
                    <figure>
                        <img src="assets/images/seo-banner-2.png">
                    </figure>
                </div>
                <div class="item">
                    <figure>
                        <img src="assets/images/seo-banner-3.png">
                    </figure>
                </div>
            </div>
        </div>
...
<section class="seo-cta">
  <div class="container">
    <p>Let's give your business the attention it deserves</p>
    <a href="<?php echo $path;?>contact.php">FREE SEO CONSULTATION </a>
  </div>
</section>
    ...
    <div class="container">
        <div class="row item item-2" id="service-01">
            <div class="col-lg-6 col-xl-5 info-black order-mobile">
                <h3>On Page SEO</h3>
                <p class="text">
                From keyword research to technical auditing to site migration, our team of technical SEOs are true experts in their field. Leave no stone unturned and trust the intricacies of on page to the Market Leader for SEO.
                </p>
                <ul>
                    <li>— Keyword Research</li>
                    <li>— 100+ Point Technical SEO Audit</li>
                    <li>— Page Content Optimization</li>
                </ul>
              
            </div>
            <div class="col-lg-6 col-xl-7  image-block">
                <img class="image-service" src="assets/images/seo-banner-2.png">
            </div>
        </div>
    </div>
        ...
        <div class="row item item-1" id="service-1">
            <div class="col-lg-7 col-md-12 image-block">
                <img class="image-service" src="assets/images/seo-banner-3.png">
            </div>
            <div class="col-lg-5 col-md-12 info-black">
                <h3>Off Page SEO</h3>
                <p class="text">
                The days of sketchy link building are over. Victorious proprietary broken link building methodology is a new approach to an old problem that gives any website an enormous advantage against search competition.
                </p>
                <ul>
                    <li>— Broken Link Building</li>
                    <li>— Anchor Text Optimization</li>
                    <li>— Toxic Link Removal</li>
                </ul>
...
<section class="services seopage">
                <div class="container">
                    <div class="content">
                        <div class="left information"><h2 class="title">We're on a mission to change your view of SEO</h2>
                            <div class="border"></div>
                            <p class="text col-md-6"><span>It’s no secret that marketing agencies carry a nasty reputation. In particular, finding the best SEO company isn’t as simple as it seems – everyone claims to have a “secret sauce” and deliver more “first page results” than the next guy. In an industry where everyone looks like everyone else, how do you separate the doers from the sayers?</p>
                            <p class="text col-md-6"><span>Our approach to SEO is uniquely built around what we know works…and what we know doesn’t work. With over 200 verified factors in play within Google’s search algorithm, most agencies will rely on old tactics that no longer work, or guess with new tactics that they hope will stick.</span></p>
                        </div>
                    </div>
                </div>
            </section>
            <section class="books seopage">
                <div class="container">
                    ...
                    <div class="list">
                        <div id='#img-hover' class="row m-book-slider">
                            <div class="col-md-4">
                                <div class="item">
                                    <a href="#">
                                        <img class="book-size" src="assets/images/seo-bullets_seo-01.svg">
                                    </a>
<!--                                    <div class="image book1 img-hover"></div>-->
                                    <h3 class="title">Data Driven Methodology</h3>
                                    <p class="description">Our USA SEO company uses data and only data to drive the campaign strategy. No guessing games.
                                        </p>
                            ...
                            <div class="col-md-4">
                                <div class="item">
                                    <a href="#">
                                        <img class="book-size" src="assets/images/seo-bullets_seo-02.svg">
                                    </a>
<!--                                    <div class="image book2 img-hover"></div>-->
                                    <h3 class="title">Complete SEO Transparency</h3>
                                    <p class="description">No hiding behind fake numbers. Every activity is tracked and available for you to access, 24 hours a day.</p>
                                    <div class="book-links">
                                        <a href="#">Let's discuss</a>
                                        <a href="tel:+19732657199">+1 973 265 7199</a>
                                    </div>
                            ...
                            <div class="col-md-4">
                                <div class="item">
                                    <a href="#">
                                        <img class="book-size" src="assets/images/seo-bullets_seo-03.svg">
                                    </a>
<!--                                    <div class="image book3 img-hover"></div>-->
                                    <h3 class="title">ROI Obsessed Campaigns</h3>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                <h3  class="wow fadeInDown">Not your traditional SEO company</h3>
                  <p class="text-center wow fadeInDown">Our approach to SEO is uniquely built around what we know works…and what we know doesn’t work. With over 200 verified factors in play within Google’s search algorithm, most agencies will rely on old tactics that no longer work, or guess with new tactics that they hope will stick.</p>
            </div>
        </div>
...
<div class='see-results'>
         <div class='container'>
            <div class='row'>
               <div class='col-md-12'>
                  <div class='result-heading text-center'>
                     <h3>See our Real Results
                        <span class='dont-belive'>We Don’t beleive in talks! </span>
                     </h3>
                  </div>
               </div>
            </div>
            <div class='row justify-content-center'>
               <div class='col-md-8'>
                  <div class='seo-results-tab'>
                     <div class='text-center'>
                        <h5>Our  recent  Results</h5>
                     </div>
                     <div class='seo-result-slide'>
                                                <div class='item'>
                           <div class='text-center'>
                              <!--<p><a href=''></a></p>-->
                              <p>www.scosmetics.com</p>
                           </div>
                           <table class='table seo-rank-table'>
                              <thead>
                                 <tr>
                                    <th>KEYWORDS</th>
                                    <th>CURRENT RANK</th>
                              ...
                              <tbody>
                                                                    <tr>
                                        <td>Kamaflage Foundation Palette</td>
                                        <td>2</td>
                                    </tr>
                                                                    <tr>
                                        <td>Online Shopping For Lipstick</td>
                                        <td>2</td>
                                    </tr>
                                                                    <tr>
                                        <td>Second Skin Liquid Foundation</td>
                                        <td>3</td>
                                    </tr>
                                                                    <tr>
                                        <td>Face Powder Palette</td>
                                        <td>3</td>
                                    </tr>
                                                                    <tr>
                                        <td>Buy Face Powder Online</td>
                                        <td>5</td>
                                    </tr>
                           ...
                           <table class='table seo-rank-table'>
                              ...
                              <tbody>
                                                                    <tr>
                                        <td>ULV Fogger Suppliers</td>
                                        <td>2</td>
                                    </tr>
                                                                    <tr>
                                        <td>Longray Carryall ULV Fogger</td>
                                        <td>4</td>
                                    </tr>
                                                                    <tr>
                                        <td>ULV Fogger for Sale</td>
                                        <td>5</td>
                                    </tr>
                                                                    <tr>
                                        <td>Thermal Fogging Equipment</td>
                                        <td>6</td>
                                    </tr>
                                                                    <tr>
                                        <td>Thermal Fogger for Sale</td>
                                        <td>7</td>
                                    </tr>
                           ...
                           <table class='table seo-rank-table'>
                              ...
                              <tbody>
                                                                    <tr>
                                        <td>Swimming School In Australia</td>
                                        <td>3</td>
                                    </tr>
                                                                    <tr>
                                        <td>Best Swimming School In Australia</td>
                                        <td>2</td>
                                    </tr>
                                                                    <tr>
                                        <td>Swimming Course In Australia</td>
                                        <td>3</td>
                                    </tr>
                                                                    <tr>
                                        <td>Swimming School Australia</td>
                                        <td>3</td>
                                    </tr>
                                                                    <tr>
                                        <td>Swimming School Australia</td>
                           ...
                           <table class='table seo-rank-table'>
                              ...
                              <tbody>
                                                                    <tr>
                                        <td>Dcole Architecture Casablanca</td>
                                        <td>3</td>
                                    </tr>
                                                                    <tr>
                                        <td>Aménagement intérieur Maroc</td>
                                        <td>4</td>
                                    </tr>
                                                                    <tr>
                                        <td>Dcole Architecture Privée</td>
                                        <td>4</td>
                                    </tr>
                                                                    <tr>
                                        <td>Dcole Supérieure Architecture Maroc</td>
                                        <td>5</td>
                                    </tr>
                                                                    <tr>
                                        <td>Dcole Architecture Rabat</td>
                                        <td>8</td>
                                    </tr>
                           ...
                           <table class='table seo-rank-table'>
                              ...
                              <tbody>
                                                                    <tr>
                                        <td>Filing a Trademark in Cuba</td>
                                        <td>1</td>
                                    </tr>
                                                                    <tr>
                                        <td>Trademark Lawyer Miami</td>
                                        <td>1</td>
                                    </tr>
                                                                    <tr>
                                        <td>Patent Lawyer Miami</td>
                                        <td>2</td>
                                    </tr>
                                                                    <tr>
                                        <td>Trademark Attorney Miami</td>
                                        <td>2</td>
                                    </tr>
                                                                    <tr>
                                        <td>Cuban Trademark Attorney</td>
                                        <td>2</td>
                                    </tr>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="contact-form">
                        <div class="content">
                            <h2 class="form-name">We can help your business grow</h2>
                        </div>
...
?>
   ...
   <section class="next-page">
          <div class="next-page-wrap">
              <a href="<?php echo $path;?>content" class="next-page__link">
                  <div class="next-page__desc">Next stop</div>
                  <div class="next-page__title">Content</div>
