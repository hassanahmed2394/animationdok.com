...
<title>Branding ain’t easy. Start in just $99.99 you’ll love.</title>
<meta name="description"  content="Working with a professional designer to codify font, color and style choices can sure make it look good." />
...
<section class="top-home myhome">
    ...
    <div class="col-lg-6 height-dog">
        ...
        <span><i>Branding ain’t easy. Start in just $99.99 you’ll love.</i></span>
        ...
        <a class="first-link" href="<?php echo $path;?>contact.php">Let's create something together</a>
  ...
  <div class="container-fluid">
    <div class="row">
      <ul>
        <li>
          <p>
            Let us design a unique <strong>branding</strong> to represent your business.
          </p>
        </li>
        <li>
          <ul class="subimages">
            <li>
              <img src="assets/images/brandingicon1.png">
              <h6>Stationary</h6>
            </li>
            <li>
              <img src="assets/images/brandingicon2.png">
              <h6>White-papers</h6>
            </li>
            <li>
              <img src="assets/images/brandingicon3.png">
              <h6>eBooks</h6>
            </li>
            <li>
              <img src="assets/images/brandingicon4.png">
              <h6>Packaging </h6>
            </li>
            <li>
              <img src="assets/images/brandingicon5.png">
              <h6>Signage </h6>
            </li>
        ...
        <li>
          <span>Get the Branding that’s right<br> for you!</span>
    ...
    <section class="applications">
        <div class="app-container"> 
            <div class="works__info mbpx-0 myport">
                <h2 class="page-title">  Brand you business!</h2>
                <p class="portfolioparagraph">Get the perfect branding - for your  business or product.</p>
            ...
            <div class="tab-custom">
                ...
                <div class="tabs tabs-logodesign current row m-app-slider no-gutters for-works-load">
                    ...
                    $portfoliologo = "includes/portfolio-branding.php"; 
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <h3  class="wow fadeInDown">Creative ideas from real people</h3>
                  <p class="text-center wow fadeInDown">There’s no better way to design a brand guide that works for your brand and product. Dok designers will send you numbers of ideas for your business’ logo, and you’ll choose your favorite. No templates. No robots. No frustrating apps. Just a 100% Full copyright and production ready files.</p>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="contact-form">
                        <div class="content">
                            <h2 class="form-name">Logo Design</h2>
                        </div>
...
?>
   ...
   <section class="next-page">
          <div class="next-page-wrap">
              <a href="<?php echo $path;?>website-design-development" class="next-page__link">
                  <div class="next-page__desc">Next stop</div>
                  <div class="next-page__title">Website Design & Development</div>
