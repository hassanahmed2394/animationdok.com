...
<title>Your product at their fingertips.</title>
<meta name="description"  content="We build world-class mobile apps across different platforms including iOS, Android, and wearable." />
...
<section class="top-home myhome">
    ...
    <div class="col-lg-6 height-dog">
        ...
        <span><i>Your product at their fingertips.</i></span>
    ...
    <div class="col-lg-6">
        <div class="fullwrap">
            <div class="mybanslider">
                <div class="item">
                    <figure>
                        <img src="assets/images/portfolio/mobile/1-pop.png" style="width: 100%;">
                    </figure>
                </div>
                <!-- <div class="item">
                    <figure>
  ...
  <div class="container-fluid">
    <div class="row">
      <ul>
        <li>
          <p>
            It's not the code that counts. It's the <strong>impact.</strong>
          </p>
        </li>
        <li>
          <ul class="subimages">
            <li>
              <img src="assets/images/mobicon1.png">
              <h6>iOS</h6>
            </li>
            <li>
              <img src="assets/images/mobicon2.png">
              <h6>Android</h6>
            </li>
            <li>
              <img src="assets/images/mobicon3.png">
              <h6>Wearable</h6>
            </li>
            <li>
              <img src="assets/images/mobicon4.png"> 
              <h6>React Native</h6>
            </li>
            <li>
              <img src="assets/images/mobicon5.png">
              <h6>Game Apps</h6>
            </li>
    ...
    <section class="applications">
        <div class="app-container"> 
            <div class="works__info mbpx-0 myport">
                <h2 class="page-title">  Our customers love their mobile apps</h2>
                <p class="portfolioparagraph">Check out recent Mobile Application we’ve created for businesses like yours.</p>
            ...
            <div class="tab-custom">
                ...
                <div class="tabs tabs-logodesign current row m-app-slider no-gutters for-works-load">
                    ...
                    $portfoliologo = "includes/portfolio-mobileapp.php"; 
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="tab-custom">
                ...
                $packageslogo = "includes/packages-mobileapp.php"; 
...
?>
   ...
   <section class="next-page">
          <div class="next-page-wrap">
              <a href="<?php echo $path;?>motion-graphics" class="next-page__link">
                  <div class="next-page__desc">Next stop</div>
                  <div class="next-page__title">Motion</div>
