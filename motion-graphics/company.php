    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-4 col-md-12">
                <p class="top">
                    The company has been on the market since 2013 starting from outsourcing UI and UX design and growing the diversity of services year by year. Now, DesignDok is a full-stack digital agency with all the specialists required for the efficient creative process from scratch.
                </p>
                <p class="bottom">
            ...
            <div class="col-lg-8 col-md-12">
                <div class="DesignDok-definition">
        ...
        <div class="video-container">
          <video id="video"
                 ...
                 autoplay
                 loop
                 style="background-image:url('https://cdn.dribbble.com/users/1145170/screenshots/6407958/smartsharp_12_1.png');width: 100%;"
                 data-silent="true"
                 src="assets/images/company.mp4">
          </video>
...
<section class="company-slider-block">
    <div class="">
            <div class="company-slider">
                <div class="item">
                    <img src="assets/images/_MG_0301.jpg">
                </div>
                <div class="item">
                    <img src="assets/images/_MG_8690.jpg">
                </div>
                <div class="item">
                    <img src="assets/images/_MG_9494.jpg">
                </div>
                <div class="item">
                    <img src="assets/images/_MG_9854.jpg">
                </div>
              </div>
    </div>
</section>
<section class="company-awards-block">
    <div class="container top">
        <h2>Awards</h2>
        <p>
        DesignDok is the team of bright creative people from various areas: UI/UX, graphic and motion design, mobile and web development, digital art.
        </p>
    </div>
    <div class="container">
        <div class="awards-logos">
            <div class="awards-logos__item">
                <img src="assets/images/1.svg" alt=""> × 4
            </div>
            <div class="awards-logos__item">
                <img src="assets/images/2.svg" alt=""> × 1
            </div>
            <div class="awards-logos__item">
                <img src="assets/images/3.svg" alt=""> × 4
            </div>
        </div>
        <div class="awards-table-wrap show">
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="team-foto">
                ...
                <img src="assets/images/photo_6.jpg">
<!--                <img id="ball" src="--><!--/images/company/team_DesignDok.jpg">-->
            </div>
        </div>
    </div>
</section>
