                        ...
                        <div role="form">
                            <form id="contactForm" method="POST" action="webpages/orderFormController.php"  enctype="multipart/form-data">
                                <div class="app-input-group">
                                    <span><input type="text" name="oName" value="" size="40" required class="input" placeholder="Name" /></span>
                                    
                                </div>
                                <div class="app-input-group">
                                    <span><input type="text"  name="oNumber" value="" size="40" required class="input" placeholder="Number" /></span>
                                ...
                                <div class="app-input-group getaquote">
                                    <span>
                                        <textarea name="oprojectdetails" cols="40" rows="6" required class="textarea " placeholder="Project Details"></textarea>
                                    </span>
