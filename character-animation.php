...
<section class="top-home myhome whiteClr" style="background-image: url(assets/images/character-animation.png);background-position: 50% 50%;
    ...
    <div class="col-lg-6 height-dog">
        ...
        <span><i>Create a character and animate it with your creative individuals.</i></span>

        </h1>
        <p class="for-anim-2"><span>Create animations for cartoons, an animated series, and live broadcasts. Or live stream your character on social media and wow your friends.</span></p>
  ...
  <div class="container">
        ...
        <div class="app-container"> 
            ...
            <div class="tab-custom">
              ...
              <ul class="tabbing-links">
                  <li class="current" data-targetit="tabs-characteranimation">Character Animation</li>
                  
                  
                </ul>

             
                <div class="tabs tabs-characteranimation current row m-app-slider no-gutters for-works-load loadmoreca">
                    <?php
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="tab-custom">
                <ul class="tabbing-links">
                  <li class="current" data-targetit="tabs-vdpackages">Character Animation </li>
                </ul>
                ...
                <?php
                $packagescharacteranimation = $_SERVER['HTTP_HOST']; 
                $packagescharacteranimation = "includes/packages-character-animation.php"; 
                include($packagescharacteranimation); 
                ?>
                </div>
