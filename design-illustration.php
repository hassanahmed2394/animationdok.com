...
<section class="top-home myhome whiteClr" style="background-image: url(assets/images/design-illustration.png);background-position: 50% 50%;
    ...
    <div class="col-lg-6 height-dog">
        ...
        <span><i>Get a custom illustration design for your business.</i></span>

        </h1>
        <p class="for-anim-2"><span>Our community of professional designers are ready to create the perfect illustration for you. Businesses across the globe have used AnimationDok to get the right illustration for their business.</span></p>
        ...
        <span class="watch-button" id="hire-us"></span> &nbsp;
         <!--<a class="first-link" href="<?php echo $path;?>contact.php">  Get your video highest views.</a>-->
  ...
  <div class="container">
        ...
        <div class="app-container"> 
            ...
            <div class="tab-custom">
              ...
              <ul class="tabbing-links">
                  <li class="current" data-targetit="tabs-design-illustration">Design Illustration</li>
                  
                  
                </ul>

             
                <div class="tabs tabs-design-illustration current row m-app-slider no-gutters for-works-load loadmoredesignIllus">
                    <?php
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="tab-custom">
                <ul class="tabbing-links">
                  <li class="current" data-targetit="tabs-vdpackages">2D illustration</li>
                </ul>
